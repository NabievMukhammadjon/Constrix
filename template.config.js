...
export default {
	...
	git: {
		repo: `https://github.com/NabievMukhammadjon/Constrix`,
		branch: `main`
	},
	navpanel: {
		dev: true,
	...
	js: {
		...
		devfiles: true,
		bundle: {
			// Система собирает весь код
			// в один JS и один CSS файлы
			// независимо от настройки styles -> codesplit
			enable: false,
		},
		react: false,
		vue: false
